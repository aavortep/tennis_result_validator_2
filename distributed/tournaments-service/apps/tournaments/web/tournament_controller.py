...
from apps.matches.internal.match import Match
from ..internal.tournament import Tournament
from ..internal.tournament_serializers import (
    AddPlayerSerializer,
...
from apps.matches.internal.match_serializers import MatchListSerializer
